...
ResOrder.status = {
	0: {name:'notConfirmed', txt:'Непроверенные', label: 'На проверке'},
	1: {name:'rejected', txt:'Отклоненные', label: 'Отклонен'},
	2: {name:'confirmed', txt:'Проверенные', label: 'Проверен'},
	3: {name:'finished', txt:'Выполненные', label: 'Выполнен'},
	4: {name:'closed', txt:'Удаленные', label: 'Удален'}
};
...
Contact.types = {
    0: {name: 'other', title: 'Всякие'},
    1: {name: 'friends', title: 'Друзья'},
    2: {name: 'enemies', title: 'Враги'}
};

...
Slot.actions = {
	0: {name: 'none', title: ''},
	1: {name: 'build', title: 'Construction'},
	500: {name: 'destroy', title: 'Demolition'},
	501: {name: 'rebuild', title: 'Rebuild '},
	502: {name: 'destroylevel', title: 'Demolition'}
};
...
Slot.tabs = {
	1: {name: 'defence', title: 'Fortification', hint: 'Fortifications are used to protect your city from ground and air attacks.'},
	2: {name: 'science', title: 'Scientific', hint: 'Scientific buildings. If you distribute citizens there, they&#39;ll begin to produce knowledge that are needed to research sciences.'},
	3: {name: 'production', title: 'Production and finances', hint: 'Production and financial buildings. If you distribute citizens there, they&#39;ll begin to produce resources or money.'},
	4: {name: 'store', title: 'Storage and trade', hint: 'Storage and trade buildings increase city storage capacity and can make land and water trade more effective.'},
	5: {name: 'culture', title: 'Culture', hint: 'Culture buildings increase the cultural limit and allow to have more population in the city.'},
	6: {name: 'war', title: 'Military', hint: 'Military buildings make it possible to train troops, increase their effectivity and also take part in the battle etc.'},
	7: {name: 'grown', title: 'Demographic', hint: 'Demographic buildings increase population growth rates in the city.'},
	8: {name: 'other', title: 'Special', hint: 'Special buildings. These are unique or even strange buildings.'},
	10: {name: 'wonder'},
	0: {name: 'all', title: 'Show all', hint: 'Show all buildings available for construction in this block.'},
};

...
document.write('<script type="text/javascript" src="' + wofhPlatform.protocol + '//' + wofhPlatform.mainDomain + '/ggen/js/en/gconst.js?1560026396' + '"><\/script>');
	
document.write('<script type="text/javascript" src="' + wofhPlatform.protocol + '//' + wofhPlatform.mainDomain + '/ggen/js/en/const.js?1614582625' + '"><\/script>');
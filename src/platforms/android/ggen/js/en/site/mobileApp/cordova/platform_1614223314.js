...
overridePlatform = function(){
    ...
    utils.overrideFunc(appl, 'loadMobileDependencies', function __func__(){
		...
		utils.loadStylesheet('ggen/css/en/site/mobileApp/mobileApp_glagna_1614209574.css', {callback: function(){
			appl.onDependenciesLoaded();
		}});
		
		appl.dependencies++;

		utils.loadScript('ggen/js/en/site/mobileApp/app/appllogin_1608525380.js', {async: false, callback: function(){
			appl.onDependenciesLoaded();
		}});
    });
};

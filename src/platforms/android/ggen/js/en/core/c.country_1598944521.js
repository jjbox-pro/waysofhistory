...
Country.posts = {
    0: {name: 'head', title: 'Leader'},
    1: {name: 'science', title: 'Sage'},
    2: {name: 'war', title: 'Battlemaster'},
    3: {name: 'economics', title: 'Treasurer'},
    4: {name: 'warHelp1', title: 'Battlemaster’s assistant'},
    5: {name: 'warHelp2', title: 'Battlemaster’s assistant'},
    6: {name: 'adviser', title: 'Counselor'},
	7: {name: 'accountant', title: 'Accountant'},
	8: {name: 'accountantHelp1', title: 'Accountant&#39;s assistant'},
	9: {name: 'accountantHelp2', title: 'Accountant&#39;s assistant'}
};
...
Country.blankCountry = new Country({name: 'Not in a country'});

...
ResOrder.status = {
	0: {name:'notConfirmed', txt:'Not verified', label: 'On Verification'},
	1: {name:'rejected', txt:'Declined', label: 'Declined'},
	2: {name:'confirmed', txt:'Verified', label: 'Verified'},
	3: {name:'finished', txt:'Completed', label: 'Completed'},
	4: {name:'closed', txt:'Deleted', label: 'Deleted'}
};
...
Contact.types = {
    0: {name: 'other', title: 'Miscellaneous'},
    1: {name: 'friends', title: 'Friends'},
    2: {name: 'enemies', title: 'Enemies'}
};

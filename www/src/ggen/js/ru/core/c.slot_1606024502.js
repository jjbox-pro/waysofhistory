...
Slot.actions = {
	0: {name: 'none', title: ''},
	1: {name: 'build', title: 'Строительство'},
	500: {name: 'destroy', title: 'Разрушение'},
	501: {name: 'rebuild', title: 'Перестройка '},
	502: {name: 'destroylevel', title: 'Разрушение'}
};
...
Slot.tabs = {
	1: {name: 'defence', title: 'Фортификационные', hint: 'Фортификационные сооружения призваны защищать твой город при нападениях как по суше так и с воздуха.'},
	2: {name: 'science', title: 'Научные', hint: 'Научные здания. Если распределить в них жителей города, они начнут приносить знания, так необходимые для изучения наук.'},
	3: {name: 'production', title: 'Производственные и финансовые', hint: 'Производственные и финансовые здания. Если распределить в них жителей города, они начнут производить ресурсы или деньги.'},
	4: {name: 'store', title: 'Складские и торговые', hint: 'Складские и торговые здания увеличивают вместимость хранилищ города и позволяют повысить эффективность торговли как по суше так и по воде.'},
	5: {name: 'culture', title: 'Культурные', hint: 'Культурные здания повышают культурный предел, что позволяет иметь больше жителей в городе.'},
	6: {name: 'war', title: 'Военные', hint: 'Военные здания дают возможность тренировать войска, повышать их эффективность, а также принимать активное участие и в самом бое и т.д.'},
	7: {name: 'grown', title: 'Демографические', hint: 'Демографические здания увеличивают прирост населения города.'},
	8: {name: 'other', title: 'Особые', hint: 'Особые здания. Здесь собраны в чем-то уникальные, необычные странные постройки.'},
	10: {name: 'wonder'},
	0: {name: 'all', title: 'Показать все', hint: 'Показать все здания доступные для этого квартала.'},
};
...
Slot.prototype.canBuildErr = function() {
	...
	var stock = this.getTown().stock.getHasList();
...
Slot.prototype.canRebuildErr = function() {
    ...
    if (!cost.isEmpty()) {
        var stock = this.getTown(wofh.town).getStock().getHasList();
...
Slot.prototype.getAdminMoneyEffect = function(pay){
	var effect = (pay === undefined ? this.getTown(wofh.town).getSlots().getPay() : pay) * this.getAdminEconEffect();

...
Town.prototype.calcPopIncRealDrop = function() {
	return -Math.max(
				...
				Math.max((this.pop.has - this.pop.culture) * lib.town.population.ungrownspeed, lib.town.population.ungrownspeedlimit)/timeMgr.DtH
			);
};
...
Town.prototype.getPopHasNow = function () {
	return this.pop.was + (this.pop.incReal * timeMgr.invDtS) * (timeMgr.getNow() - this.pop.upd);
};

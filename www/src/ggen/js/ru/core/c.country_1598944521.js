function Country (data, unknow) {
	...
	Country.prototype.checkUnknown = function(){
		if( this.name == Country.unknown ){
			this.name = 'Несуществующая страна';
			this.unknown = true;
		}
	};
...
Country.posts = {
    0: {name: 'head', title: 'Глава'},
    1: {name: 'science', title: 'Мудрец'},
    2: {name: 'war', title: 'Воевода'},
    3: {name: 'economics', title: 'Казначей'},
    4: {name: 'warHelp1', title: 'Помощник воеводы'},
    5: {name: 'warHelp2', title: 'Помощник воеводы'},
    6: {name: 'adviser', title: 'Советник'},
	7: {name: 'accountant', title: 'Учётчик'},
	8: {name: 'accountantHelp1', title: 'Помощник учётчика'},
	9: {name: 'accountantHelp2', title: 'Помощник учётчика'}
};
...
Country.blankCountry = new Country({name: 'Не состоит в стране'});

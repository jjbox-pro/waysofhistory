...
Utils.prototype.removeFile = function(filePath) {
...
Utils.prototype.getDirName = function(filePath){
...
Utils.prototype.makeSymlink = function(targetPath, distPath, type){
	if( utils.isDirExist(distPath) )
		utils.removeFile(distPath);
	
	return fs.symlinkSync(targetPath, distPath, type);
};
